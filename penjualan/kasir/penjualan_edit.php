...
if(isset($_POST['simpan'])){
    ...
    if($jumlah > $stok){
        ...
        echo "<script>alert('Data berhasil diupdate'); window.location='form_penjualan.php';</script>";
    }
}
?>
...
<div class="card shadow-sm card-custom">
    <div class="card-body">
        <form method="POST">
            ...
            <button type="submit" name="simpan" class="btn btn-dark">Update</button>
...
// Hitung total harga saat halaman load
updateTotal();
</script>
