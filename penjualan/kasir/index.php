...
$q_penjualan = mysqli_query(
    $koneksi,
    "SELECT SUM(total_harga) AS penjualan_hari_ini 
     FROM penjualan WHERE tgl_jual = '$tanggal_hari_ini'"
);
    ...
    <div class="col-md-4">
        <div class="card card-custom text-center">
            <div class="card-body">
                ...
                <h3><?= $data_transaksi['total_transaksi']; ?></h3>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-4">
        <div class="card card-custom text-center">
            <div class="card-body">
                ...
                <h3>
                    Rp <?= number_format($data_penjualan['penjualan_hari_ini'] ?? 0, 0, ',', '.'); ?>
                </h3>
            </div>
        </div>
    </div>
